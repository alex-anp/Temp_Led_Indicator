...
#define maxTemp   34  // и больше - Предельная температура (диод горит красным)
#define warnTemp  32  // и больше - Опасная температура (диод мигает красным)
#define normTemp  30   // и больше - Рабочая температура (диод горит зеленым)
#define lowTemp   28    // и больше - Прогревочная температура (диод мигает зеленым)
